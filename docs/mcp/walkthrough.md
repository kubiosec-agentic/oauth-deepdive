...
→ See [Authorization Code + PKCE](../flows/authorization-code-pkce.md) for how this login stays safe, and the [authorization step](../02-concepts-vocabulary.md#the-authorization-step--where-the-user-comes-in) for what's happening behind the prompt.
...
→ See [Resource indicators](04-resource-indicators.md) for the stamping, and [Refresh Token](../flows/refresh-token.md) for the renewal.
