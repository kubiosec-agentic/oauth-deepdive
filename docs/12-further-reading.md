...
- [kubiosec-agentic/aws-sts-attribution](https://github.com/kubiosec-agentic/aws-sts-attribution): the audit/attribution layer for workload identity. Detects AWS STS role-assumption events in near-real-time and attributes GitHub Actions OIDC and MCP-gateway sessions back to a repo/branch/workflow or a specific human + tool. Terraform + Lambda. Pairs with [Chapter 9](09-workload-identity.md).
